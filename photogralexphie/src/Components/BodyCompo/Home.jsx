...
export const Home = () => {
  return (
    <Parallax pages={2.1} className="home-page" style={{ zIndex: "-1" }}>
      <ParallaxLayer
        offset={0}
        speed={0}
        //sticky={{ start: 0.5 }}
        ...
        <div className="home-content-down">
          <div className="home-content-part-one">
            <div className="part-one-text">
              ...
              <p>
                ...
                qui doit être mit en valeur, à travers les couleurs, les
                regards, l'amour entre deux personnes, on peut voir la beauté
                dans chacune de ses facettes.
                <br />
                <br />
                Je propose des tarifs bas, du à mon titre d'amatrice, je n'en
                vie pas j'ai un travail à côté me permettant de stabiliser mes
          ...
          <div className="home-content-part-two">
            <div className="part-two-text">
              <p>
                Faites un petit détour voir mon travail, si cela vous tente !
              </p>
              <Link to="/portfolio">
